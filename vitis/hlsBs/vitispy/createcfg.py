...
exe_args = configuration.exe_args(
    configuration.file_and_type(
        args.ifile, args.itype), configuration.file_and_type(
            args.cfile, args.ctype), configuration.file_and_type(
                args.gfile, args.gtype), args.ntests, args.csim)
