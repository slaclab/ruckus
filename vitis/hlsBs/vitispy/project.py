...
class Project:
    ...
    def __init__ (self,
        ...
        if project_files and needs :
            ...
            files    = []
            if isinstance (project_files, list) : files =  project_files
            else                                : files = [project_files]
    ...
    def print_prj_files (self, printer, pad, verbose) :
        ...
        if verbose and len (self.prj_files) > 1 : field += 's'
    ...
    def print_project (self, printer, verbose) :
        ...
        if self.package : self.package.print (printer)
        if self.vivado  : self.vivado .print (printer)
