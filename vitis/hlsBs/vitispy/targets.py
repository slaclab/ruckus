...
class Targets:
    ...
    def classify(workspace, products, targets, filters, configurations):
        ...
        #       global symbols are.
        # -----------------------------------------------------------
        RemoveLocals({'vitis_version': Version.version})
        ...
        for product in products:
            ...
            for prd_target in prd_targets:
                ...
                # directories to see if there is a cruft in there. This is
                ...
                # thought to reside.
                #
                # At one time thought substituting the local symbols
                # as '*'
                ...
                # -----------------------------------------
                # If we have already seen this cfg_wc, move on
                # -----------------------------------------
                ...
                for file in files:
                    # ---------------------------------------
                    # If we have already seen this file, move on
                    # ---------------------------------------
...
if __name__ == "__main__":
    ...
    classes = Targets.classify(
        workspace, project.products, targets, trim, None)
    print("\n\nResults")
