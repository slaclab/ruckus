    ...
    class Package:
        ...
        class Ip:
            ...
            def add_arguments(parser):   # Package.Ip
                parser.add_argument(
                    '--ip_package', help='Package Name', action='append', dest='package')
                parser.add_argument(
                    '--ip_vendor',  help='Package Vendor', dest='vendor')
                parser.add_argument(
                    '--ip_library', help='Library', dest='library')
                parser.add_argument(
                    '--ip_version', help='Version Number', dest='version')
        ...
        class Output:
            ...
            def add_arguments(parser):       # Package.Output
                ...
                parser.add_argument(
                    '--syn',    action='store_true', help='Synthesis Output')
                return
            # ------------------------------------------------------------------
