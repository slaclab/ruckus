...
# VITIS_PRJ so the CMake-time expansion matches) keeps both spellings
# identical.
...
platform = client.create_platform_component(
    name=platform_name, hw_design=xsa_path)
...
if not elf_list:
    vitis.dispose()
    raise RuntimeError(
        f'build.py: no .elf produced under {app.component_location}')
